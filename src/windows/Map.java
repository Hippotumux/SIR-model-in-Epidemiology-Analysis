...
public class Map {
	...
	public void start() {
		...
		for (int x = 0; x < 500; x++) {
			for (int y = 0; y < 300; y++) {
				if (x < bl || y < bl || x >= 500 - bl || y >= 300 - bl)
					map[x][y] = 0;
				else
					map[x][y] = 1;
				if (y >= 300 - bl && x >= bl && x < 300 - bl)
					map[x][y] = 1;
			}
		}
		...
		for (int x = 0; x < 300; x++) {
			for (int y = 300; y < 450; y++) {
				if (x < bl || y < 300 + bl || x >= 300 - bl || y >= 450 - bl)
					map[x][y] = 0;
				else
					map[x][y] = 1;
				if (y < 300 + bl && x >= bl && x < 300 - bl)
		...
		for (int x = 700; x < 900; x++) {
			for (int y = 50; y < 300; y++) {
				if (x < 700 + bl || y < 50 + bl || x >= 900 - bl || y >= 300 - bl)
					map[x][y] = 0;
				else
					map[x][y] = 2;
			}
		...
		for (int x = 400; x < 750; x++) {
			for (int y = 500; y < 600; y++) {
				if (x < 400 + bl || y < 500 + bl || x >= 750 - bl || y >= 600 - bl)
					map[x][y] = 0;
				else
					map[x][y] = 3;
			}
